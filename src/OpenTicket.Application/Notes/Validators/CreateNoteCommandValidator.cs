...
public sealed class CreateNoteCommandValidator : IValidator<CreateNoteCommand>
{
    private const int MaxTitleLength = 200;
    private const int MaxBodyLength = 10000;

    public Task<ValidationResult> ValidateAsync(CreateNoteCommand instance, CancellationToken ct = default)
    {
